...
def cal_ssim_rgb(img1, img2):
    ...
    for channel in range(num_channels):
        ...
        sigma1_sq = (
            signal.convolve2d(img1_channel * img1_channel, window, "valid") - mu1_sq
        )
        sigma2_sq = (
            signal.convolve2d(img2_channel * img2_channel, window, "valid") - mu2_sq
        )
        sigma12 = (
            signal.convolve2d(img1_channel * img2_channel, window, "valid") - mu1_mu2
        )
