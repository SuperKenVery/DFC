...
class BaseMuLUT_DFC(nn.Module):
    ...
    def __init__(self, lut_folder, stages, modes, lutName, interval, compressed_dimensions, diagonal_width, sampling_interval, c_in=3):
    ...
    def __init__(self, lut_folder, stages, modes, lutName, interval, compressed_dimensions, diagonal_width, sampling_interval, sample_size, c_in = 1):
        ...
        for s in range(6):
            ...
            for c in range(channels):
                for mode in modes:
                    lut_path = os.path.join(lut_folder,"{}_s{}_c{}_{}_compress1.npy".
                    ...
                    lut_path = os.path.join(lut_folder, "{}_s{}_c{}_{}_compress2.npy".
                                            format(lutName, str(stage), str(c), mode))
                    if not os.path.exists(lut_path):
                        continue
